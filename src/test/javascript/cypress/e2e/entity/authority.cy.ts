...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'ae76e153-3234-4618-88f6-8537702dd2e0' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('0af93b8e-f529-4834-a97d-3ebe3f72112c');
      cy.get(`[data-cy="name"]`).should('have.value', '0af93b8e-f529-4834-a97d-3ebe3f72112c');
